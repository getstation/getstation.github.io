...
export const Types = {
  ...
  linkedin: (
    <path d="M50 0C22.4 0 0 22.4 0 50s22.4 50 50 50 50-22.4 50-50S77.6 0 50 0zM36.7 74.2h-11V38.7h11v35.5zm-5.6-40.1c-3.6 0-6.5-2.9-6.5-6.5s2.9-6.5 6.5-6.5 6.5 2.9 6.5 6.5c0 3.5-2.9 6.4-6.5 6.5zm46.7 40.1H66.9V55.6c0-5.1-1.9-8-6-8-4.4 0-6.7 3-6.7 8v18.6H43.7V38.7h10.5v4.8s3.2-5.9 10.7-5.9 12.9 4.6 12.9 14.1v22.5z"/>
  ),
  linux: (
